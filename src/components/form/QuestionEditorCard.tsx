...
export const QuestionEditorCard: React.FC<QuestionEditorProps> = ({
  question,
  index,
  onUpdate,
  onDelete,
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 mb-4 border-2 border-gray-100 hover:border-purple-200 transition-all">
      {/* Header */}
